...
function Masthead({ source, articleCount, fontSize, articles }) {
  return (
    <header style={{
      background: "#f5efe0",
      borderBottom: "4px double #1a1008",
      paddingBottom: "0",
    }}>
  ...
  return (
    <div style={{
      ...
      backgroundImage: `repeating-linear-gradient(
        ...
        rgba(180,140,80,0.06) 31px, rgba(180,140,80,0.06) 32px
      )`,
    }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "0 24px" }}>
          <div style={{
            ...
            <span>drag slider above to reflow · click sentences to pull quotes</span>
          </div>
